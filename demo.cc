...
main (int argc, char *argv[])
{
  ...
  pointToPoint[0].SetChannelAttribute ("PerPacketSymbolicDelay", BooleanValue (true));
  ...
  pointToPoint[1].SetChannelAttribute ("PerPacketSymbolicDelay", BooleanValue (true));
